...
week = st.number_input('Enter week number', min_value=1.0, max_value=52.0, step=0.1)
weekofyear = st.number_input('Enter week of year', min_value=1.0, max_value=52.0, step=0.1)
